...
public class Scheduler {
	...
	public Scheduler() {
		...
		handler2 = new ElevatorHandler(EPORT2, FPORT, pickList2, 2000, "IDLE", 2);
		handler3 = new ElevatorHandler(EPORT3, FPORT, pickList3, 2000, "IDLE", 3);
		handler4 = new ElevatorHandler(EPORT4, FPORT, pickList4, 2000, "IDLE", 4);
	}
